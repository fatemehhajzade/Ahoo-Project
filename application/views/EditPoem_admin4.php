							...
							<div class="card border-0 shadow-lg">
								...
								<div class="card-body review2">
									<form style="width: 710px"  method="post" action="<?php echo base_url()?>index.php/ahooController/Editpoems">
										...
										<div class="form-group">
											<input type="radio" id="rdbtn-1" value="مثنوی معنوی" <?php echo $row2["book"]== "مثنوی معنوی" ? 'checked' : ''; ?> class="inpt-brdr-c" name="book" >
											<label for="rdbtn-1" class="lab-txt-c">مثنوی معنوی</label>
										</div>
										<div class="form-group">
											<input type="radio" id="rdbtn-2" value="دیوان شمس" <?php echo $row2["book"]== "دیوان شمس" ? 'checked' : ''; ?> class="inpt-brdr-c" name="book">
											<label for="rdbtn-2" class="lab-txt-c">دیوان شمس</label>
										</div>
										<div class="form-group">
											<input type="radio" id="rdbtn-2" value="دیوان اشعار" <?php echo $row2["book"]== "دیوان اشعار" ? 'checked' : ''; ?> class="inpt-brdr-c" name="book">
											<label for="rdbtn-2" class="lab-txt-c">دیوان اشعار</label>
										</div>
