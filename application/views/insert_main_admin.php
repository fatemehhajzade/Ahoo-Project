		...
		<div class="mt-4 mb-5">
			<div class="container">
						...
						<div class="col-12">
							<div class="card border-0 shadow-lg">
								<div class="col-12 text-center text-dark pt-3">
									<h4 style="font-family: iybd">درج شعر</h4>
								</div>
								<div class="card-body review2">
									<form style="width: 710px" method="post" action="<?php echo base_url()?>index.php/ahooController/insertPoem">
										<div class="form-group">
											<p class="mb-1"> عنوان شعر </p>
											<input class="form-control" name="name" type="text" placeholder="عنوان شعر را وارد کنید ...">
										</div>
										<font color=red><?php echo form_error('name');?></font>
										<div class="form-group mb-4">
											<p class="mb-1"> متن شعر </p>
											<div class="div-brdr">
												<textarea id="editor" class="form-control" name="poem" style="text-align: right" cols="30" rows="7" placeholder="کلمه ای وارد کنید ..."></textarea>
											</div>
											<font color=red><?php echo form_error('poem');?></font>
										</div>
										<font color=red><?php echo form_error('pname');?></font>
										<font color=red><?php echo form_error('form');?></font>
										<font color=red><?php echo form_error('book');?></font>
										<div class="row mb-3">
											<div class="col-12">
												<div class="d-flex justify-content-center align-items-center text-center">
													<select name="pname" class="custom-select ml-3 select-custom">
														<option selected>نام شاعر ...</option>
													...
													<select name="form" class="custom-select ml-3 select-custom">
														<option selected>قالب شعری ...</option>
			 ...
			 <option value="مثنوی">مثنوی</option>
													...
													<select name="book" class="custom-select select-custom">
														<option selected>نام اثر ...</option>
			 ...
			 <option value="شرق اندوه">شرق اندوه</option>
			 <option value="آوار آفتاب">آوار آفتاب</option>													</select>
												</div>
											</div>
										</div>
									
                                   <input class="btn signup-btn py-2" style="width: 710px" type="submit" name="submit" id="submit" value="درج شعر ">								</div>
									</form>
							</div>
						</div>
					</div>
