		...
		<div class="container">
			<nav class="navbar navbar-light px-0">
				...
				<div class="nav-item form-group ml-0 d-flex flex-row hsearch mb-0">
					<input pe="text" class="form-control rounded-pill border-0 pt-1 pb-1" placeholder="کلمه مورد نظر خود را وارد کنید ...">
					<a href="#" class="btn text-light"> <i class="fa fa-search align-middle" style="font-size: 13px"></i> </a>
				</div>
	...
	<div class="container">
		<div class="row">
		  <div class="col-12">
		    ...
		    <?php
            $j=1;
            foreach (json_decode($data2, true) as $row):   
